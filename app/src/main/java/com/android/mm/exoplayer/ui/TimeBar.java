...
public interface TimeBar {
     ...
     *
     * @param adGroupTimeMs     An array where the first {@code adGroupCount} elements
     *                          are the times of ad groups in milliseconds. May be {@code null}
     *                          if there are no ad groups.
     * @param playedAdGroups    An array where the first {@code adGroupCount} elements indicate
     *                          whether the corresponding ad group have been played. May be {@code null} if
