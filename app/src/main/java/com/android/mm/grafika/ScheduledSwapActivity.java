...
import com.android.mm.grafika.gles.GlUtil;
 ...
 */
public class ScheduledSwapActivity extends Activity implements AdapterView.OnItemSelectedListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_swap_scheduled);

        // Update-rate spinner; specifies the frame rate.
        Spinner spinner = (Spinner) findViewById(R.id.scheduledSwapUpdateSpinner);
        ...
        spinner = (Spinner) findViewById(R.id.scheduledSwapAheadSpinner);
        ...
        SurfaceView sv = (SurfaceView) findViewById(R.id.scheduledSwapSurfaceView);
