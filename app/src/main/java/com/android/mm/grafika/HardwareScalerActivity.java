...
import com.android.mm.grafika.gles.GeneratedTexture;
import com.android.mm.grafika.gles.GlUtil;
import com.android.mm.grafika.gles.Sprite2d;
import com.android.mm.grafika.gles.Texture2dProgram;
import com.android.mm.grafika.gles.WindowSurface;
import com.android.mm.grafika.gles.FlatShadedProgram;
...
public class HardwareScalerActivity extends Activity implements SurfaceHolder.Callback,
    ...
    public void onRadioButtonClicked(View view) {
        ...
        ((TextView) findViewById(R.id.viewSizeValueText)).setText(wh[0] + "x" + wh[1]);
    ...
    private static class RenderThread extends Thread {
        ...
        private void setFlatShading(boolean useFlatShding) {
            mUseFlatShading = useFlatShding;
        }
