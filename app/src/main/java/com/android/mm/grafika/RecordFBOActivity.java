...
public class RecordFBOActivity extends Activity implements
    ...
    private class RenderThread extends Thread {
        ...
        private void startEncoder() {
            ...
            // 不断地层MediaCodec中取出数据，Surface是MediaCodec传递进去的。
        ...
        /**
         * Stop the video encoder if it's running.
         */
        ...
        /**
         * Advance state and draw frame in response to a vsync.
         */
