 ...
 * <p>
 * Not thread-safe.
 * 实现CircularEncoder需要的功能，以后再详细研究。
 */
public class CircularEncoderBuffer {
    ...
    /**
     * Computes the amount of time spanned by the buffered data, base on the presentation
     * time stamps.
     */
    ...
    /**
     * Add a new encoded data packet to the buffer.
     *
     *
     */
