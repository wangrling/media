...
int main(int argc, char *argv[]) {
    ...
    for (int i = 0;; i++) {
        ...
        if(i&1) ret = avformat_seek_file(context, stream_id, INT64_MIN, timestamp, timestamp, 0);
        else    ret = avformat_seek_file(context, stream_id, timestamp, timestamp, INT64_MAX, 0);
