...
Java_com_android_mm_ndk_OpenMaxActivity_createEngine(JNIEnv *env, jclass type) {
...
Java_com_android_mm_ndk_OpenMaxActivity_createStreamingMediaPlayer(JNIEnv *env, jclass type,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_android_mm_ndk_OpenMaxActivity_setPlayingStreamingMediaPlayer(JNIEnv *env, jclass type,
                                                                       jboolean isPlaying) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_android_mm_ndk_OpenMaxActivity_shutdown(JNIEnv *env, jclass type) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_android_mm_ndk_OpenMaxActivity_setSurface(JNIEnv *env, jclass type, jobject surface) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_android_mm_ndk_OpenMaxActivity_rewindStreamingMediaPlayer(JNIEnv *env, jclass type) {
