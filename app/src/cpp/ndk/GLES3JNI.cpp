...
extern "C" {
JNIEXPORT void JNICALL Java_com_android_mm_ndk_GLES3JNIActivity_init(JNIEnv *env, jclass type);
JNIEXPORT void JNICALL Java_com_android_mm_ndk_GLES3JNIActivity_resize(JNIEnv *env, jclass type, jint width, jint height);
JNIEXPORT void JNICALL Java_com_android_mm_ndk_GLES3JNIActivity_step(JNIEnv *env, jclass type);
}

JNIEXPORT void JNICALL
Java_com_android_mm_ndk_GLES3JNIActivity_init(JNIEnv *env, jclass type) {
...
JNIEXPORT void JNICALL
Java_com_android_mm_ndk_GLES3JNIActivity_resize(JNIEnv *env, jclass type, jint width, jint height) {
...
JNIEXPORT void JNICALL
Java_com_android_mm_ndk_GLES3JNIActivity_step(JNIEnv *env, jclass type) {
